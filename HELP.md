...
* The original package name 'app.navigational.Routing-Report-System' is invalid and this project uses 'app.navigational.RoutingReportSystem' instead.
...
* [Spring for RabbitMQ](https://docs.spring.io/spring-boot/docs/3.2.0-M2/reference/htmlsingle/index.html#messaging.amqp)
